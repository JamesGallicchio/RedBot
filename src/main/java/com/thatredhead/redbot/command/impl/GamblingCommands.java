...
public class GamblingCommands extends CommandGroup {
    ...
    public static class SlotsCommand extends Command {
        ...
        public static final double CHARGE = 25.0;

        public static final double REWARD_NORMAL = 50.0;
        public static final double REWARD_HIGH = 100.0;
        public static final double REWARD_JACKPOT = 1000.0;

        public static final double CHANCE_NORMAL = 0.355;
        public static final double CHANCE_HIGH = 0.05;
        public static final double CHANCE_JACKPOT = 0.002;
